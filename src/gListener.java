...
public interface gListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code BoolString}
	 * labeled alternative in {@link }.
	 * @param ctx the parse tree
	 */
	void enterBoolString(gParser.BoolStringContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BoolString}
	 * labeled alternative in {@link }.
	 * @param ctx the parse tree
	 */
	void exitBoolString(gParser.BoolStringContext ctx);
	/**
